...
test_txt_file = "/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/src_149_code/test_data_traj/selected_test_traj.txt"
...
val_txt_file = "/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/src_149_code/val_data_traj/selected_val_traj.txt"
...
trainer = SimpleModelTrainerCpu(
    ...
    epochs=2,
    patience=5,
    run_name="GPU Segement Code Test",
    lr=5e-4,
    lr_patience=7,
    ...
    batch_size=256,
    log_debug_data=True,
    results_dir="/home/arjav.singh/DeepIO/Production_Data/SIDM/after_training",
)
