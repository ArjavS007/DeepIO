from models import LSTMModelV3, LSTMStateConverter, StatefulLSTMModelV3
...
if __name__ == "__main__":
    ...
    # train_flights = flight_paths[6:10]
    # val_flights = flight_paths[4:6]
    # test_flights = flight_paths[1:3]
    ...
    checkpoint_path = "/home/perception/Projects/DeepIO/Production_Data/SIDM/training_results/GPU Train 14-20250929-124430/checkpoints/best_model.pt"
    ...
    trainer = SimpleModelTrainerCpu(
        ...
        epochs=1000,
        patience=10,
        run_name="Stateful_Model_Training_1",
        lr=5e-4,
        lr_patience=7,
        ...
        pad_test_data=True,
        clip_gradients=True,
        description="Trainig a stateful model.",
        wandb_logging=True,
        batch_size=256,
        log_debug_data=True,
        results_dir="/home/perception/Projects/DeepIO/Production_Data/new_SIDM/training_results",
        is_stateful=True,
    )
