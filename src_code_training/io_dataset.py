...
class IODatasetCpu(Dataset):
    def __init__(
        self, flight_paths, window_size=200, check_for_hold=False, check_for_lag=False
    ):
        ...
        self.load_data_preproc_every_1_sec(self.check_for_hold, self.check_for_lag)
    ...
    def load_data_preproc_every_1_sec(self, check_for_hold=True, check_for_lag=True):
        print("Loading data...")
