...
from _distiller_model_cpu import DistillerCpu
import os
...
# test_flights = flight_paths[2:4]


teacher_model = LSTMModelV3(in_dim=11, hidden_size=1400, output_size=2)
checkpoint_path = "/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/training_results/GPU Train 17-20251010-103406/checkpoints/best_model.pt"
...
student_model = LSTMModelV3(in_dim=11, hidden_size=300, output_size=2)
...
trainer = DistillerCpu(
    ...
    epochs=2,
    patience=5,
    run_name="Model_Distil_LSTM_V3_CPU_Trial_1",
    lr=5e-4,
    lr_patience=7,
    last_lr_change_patience=5,
    use_lr_scheduler=True,
    clip_gradients=True,
    description="Distilling the LSTM Model V3 on CPU",
    wandb_logging=False,
    batch_size=256,
    log_debug_data=True,
    results_dir="/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/distilling_results",
)
