...
class SimpleModelTrainerCpu:
    def __init__(
        ...
        is_stateful=False,
        tune=False,
        saved_train_data_path=None,
        saved_val_data_path=None,
        saved_test_data_path=None,
    ):
        ...
        if self.tune:
            self.train_data = torch.load(saved_train_data_path, weights_only=False)
        ...
        if self.tune:
            self.val_data = torch.load(saved_val_data_path, weights_only=False)
        ...
        self.test_data = None
        if self.tune:
            self.test_data = torch.load(saved_test_data_path, weights_only=False)
        else:
