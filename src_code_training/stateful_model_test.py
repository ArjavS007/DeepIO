...
if __name__ == "__main__":
    ...
    checkpoint_path = "/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/training_results/GPU Train 16-20251009-013400/checkpoints/best_model.pt"
    stateless_model = LSTMModelV3(in_dim=11, hidden_size=100, output_size=2)
    ...
    checkpoint = {
        "model_state_dict": stateful_model.state_dict(),
    }
    filename = "/home/arjav.singh/Projects/DeepIO/Production_Data/SIDM/training_results/stateful_model_16.pt"
    ...
    trainer = SimpleModelTrainerCpu(
        ...
        epochs=30,
        patience=5,
        run_name="Converted_Models_Test",
        lr=1e-5,
        lr_patience=7,
